...
import { Building, ChevronLeft, Eye, EyeOff } from "lucide-react";
...
const registerSchema = z.object({
  ...
  address: z.string().min(6, "Endereço inválido"),
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-npj-blue mt-2">Cadastro de Cliente</h1>
          <p className="text-gray-600 mt-1">Preencha seus dados para acesso ao sistema</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Seus dados são necessários para atendimento jurídico
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
